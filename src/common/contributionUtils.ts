...
export const enum Contributions {
  EventListenerBreakpointView = 'jsEventListenerBreakpoints',
  XHRFetchBreakpointsView = 'jsXHRBreakpoints',
  DiagnosticsView = 'jsDebugDiagnostics',
}

export const enum CustomViews {
  BrowserElements = 'jsBrowserElements',
  BrowserElementsStyles = 'jsBrowserElementsStyles',
  BrowserElementsComputed = 'jsBrowserElementsComputed',
  BrowserElementsLayout = 'jsBrowserElementsLayout',
  BrowserElementsProperties = 'jsBrowserElementsProperties',

  EventListenerBreakpoints = 'jsEventListenerBreakpoints',
  XHRFetchBreakpoints = 'jsXHRBreakpoints',
  ExcludedCallers = 'jsExcludedCallers',
}

export const enum Commands {
  OpenBrowserElements = 'extension.js-debug.openBrowserElements',
...
const commandsObj: { [K in Commands]: null } = {
  [Commands.OpenBrowserElements]: null,
...
export const enum ContextKey {
  ...
  CurrentFile = 'jsDebugCurrentFile',
}
